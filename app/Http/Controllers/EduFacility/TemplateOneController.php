...
class TemplateOneController extends Controller
{
    ...
    {
        return view('edu-facility.tempOne.form'); // اختياري: نموذج يدخل المستخدم فيه النص
    }
    ...
    public function generate(Request $request)
    {
        ...
        return view('edu-facility.tempOne.preview', compact('data'));
    }
    ...
    public function downloadPdf(Request $request)
    {
        ...
        $html = view('edu-facility.tempOne.pdf', compact('data','Logo','mang'))->render();
       ...
       public function preview(Request $request)
    {
        ...
        return view('edu-facility.tempOne.preview', compact('data','Logo','mang'));
    }
}
