...
<div class="letter-form-wrapper">
    ...
    <form method="post" action="{{ route('edu-facility.letter.word') }}" style="margin-top: 16px;" onsubmit="document.getElementById('word_title').value=document.getElementById('letter_title').value;document.getElementById('word_content').value=document.getElementById('letter_content').value;">
        @csrf
