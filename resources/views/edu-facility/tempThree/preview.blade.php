...
<head>
    ...
    <style>
        body { 
            ...
            color: #0f172a;
            max-width: 200vw;
            background:   url('{{asset('assets/Templates/3.jpg') }}') center/cover ;
            max-height: 100vh;
        }
        ...
        .signature { margin-left: 100px; font-size: 15px; text-align: left;  }
    </style>
</head>

<body dir="rtl" >
    <div style="padding-top:15%">
    <div style=" position: absolute; margin-right:5%; top:25%; ">
