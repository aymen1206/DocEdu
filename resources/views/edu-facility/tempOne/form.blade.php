...
<div class="letter-form-wrapper">
    ...
    <form method="post" action="{{ route('edu-facility.tempOne.pdf') }}" id="pdfForm">
        @csrf
    ...
    <form method="post" action="{{ route('edu-facility.tempOne.word') }}" style="margin-top: 16px;" onsubmit="document.getElementById('word_title').value=document.getElementById('letter_title').value;document.getElementById('word_content').value=document.getElementById('letter_content').value;">
        @csrf
    ...
    <form method="post" action="{{ route('edu-facility.tempOne.preview') }}" style="margin-top: 16px;" onsubmit="document.getElementById('preview_title').value=document.getElementById('letter_title').value;document.getElementById('preview_content').value=document.getElementById('letter_content').value;">
        @csrf
